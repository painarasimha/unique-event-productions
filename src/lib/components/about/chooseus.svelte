...
<section class="max-w-4xl px-4 py-5 md:px-8 md:py-8">
	...
	<p class="mb-8 text-justify font-sans text-sm md:text-xl">
		...
		preferences, and aspirations, we ensure no detail is overlooked. This personal touch results in
		events that reflect your personality, values, and style.
	</p>
	<p class="mb-2 font-serif font-semibold md:text-[24px]">Where Creativity Meets Strategy</p>
	<p class="mb-8 text-justify font-sans text-sm md:text-xl">
		Our team blends artistic creativity with strategic planning to design intelligent, breathtaking
		events. From initial concepts to the finest details—décor, lighting, entertainment, and
		ambiance—every element is meticulously crafted to bring your vision to life seamlessly.
	</p>
	<p class="mb-2 font-serif font-semibold md:text-[24px]">Flawless Execution, Memorable Results</p>
