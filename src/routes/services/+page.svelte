...
<div class="mx-auto flex w-full max-w-screen-xl flex-col border bg-gray-200/70 py-6 md:container">
	<h1 class="mx-auto mb-8 text-center font-serif text-2xl md:text-5xl">Services</h1>
